...
const SetupScreen: React.FC<SetupScreenProps> = ({ onComplete, onChangeAI }) => {
    ...
    <div className="max-w-2xl mx-auto py-12 px-6">
      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 p-8 md:p-12 space-y-8">
        ...
        {onChangeAI && (
          <button 
            onClick={onChangeAI}
            className="w-full mt-4 py-3 text-xs font-black text-gray-400 uppercase tracking-widest hover:text-indigo-600 transition-colors flex items-center justify-center gap-2"
          >
